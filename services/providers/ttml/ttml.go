...
// Returns: raw TTML string, track duration in ms, similarity score, ISRC, error
func FetchTTMLLyrics(songName, artistName, albumName string, durationMs int) (string, int, float64, string, error) {
	...
	return ttml, trackDurationMs, score, track.Attributes.ISRC, nil
}
